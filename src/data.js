export const placeInfo = [
  ...
  {
    id: 3,
    headerTitle: 'Hospitals & Phamacies',
...
export const reviews = [
  {
    ...
    comment:
      'The Amezon Frenh Press is cheap, easy to wash, easy to use and very fast. It takes me no more than 3 minutes to have my coffee after having boiling water into it. It also allows me to make my coffee stronger or lighter depending on my mood, friends, etc..'
  },
  {
    id: 2,
    name: 'Mike',
